...
The current version of the script only supports the season episode naming convention.

# Usage:
Simply write "bash frename "<directory path>"" and the script does the rest. The folder path must be passed as string(as of Dec-2025).
